...
void CmndStatus(void)
{
  ...
  if ((0 == payload) || (2 == payload)) {
    Response_P(PSTR("{\"" D_CMND_STATUS D_STATUS2_FIRMWARE "\":{\"" D_JSON_VERSION "\":\"%s%s%s\",\"" D_JSON_KC_VERSION "\":\"%s\",\"" D_JSON_BUILDDATETIME "\":\"%s\""
#ifdef ESP8266
                          ...
                          "%s}}"),
                          TasmotaGlobal.version, TasmotaGlobal.image_name, GetCodeCores().c_str(), TasmotaGlobal.kc_version, GetBuildDateAndTime().c_str()
#ifdef ESP8266
                          , ESP.getBootVersion()
#endif
                          , ESP.getSdkVersion(),
